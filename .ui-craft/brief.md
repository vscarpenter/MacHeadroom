...
System Headroom is a native macOS menu bar utility that reveals the apps using the most CPU and memory after collapsing each app's related processes into one understandable row.
...
- **2026-08-10** — The customer-facing product name is “System Headroom”; internal target, module, and bundle identifiers remain `SystemHeadroom`. *Why:* Apple required removing “Mac” from the product name while preserving the submitted bundle identifier.
